document.addEventListener('DOMContentLoaded', function () {
    ...
    const profilebasic = document.querySelector('.imgperfildiv');
    ...
    // Garante que a foto de perfil padrão esteja no LocalStorage ao carregar a pagina paraevitar erros de carregamento
    if (!userData.profilePic) {
        userData.profilePic = "img/man.png";
        localStorage.setItem('userData', JSON.stringify(userData));
        updateProfileDisplay();
    }
