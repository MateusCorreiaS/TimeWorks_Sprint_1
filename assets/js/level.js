document.addEventListener('DOMContentLoaded', function () {
    ...
    function xpbar() {
        ...
        if (calcpercent < 25 ){}
        xpbarelement.innerHTML`<img src="img/xp0.png" alt="xpbar" class="xpbarclass">`             
    }
        if (calcpercent > 25 && calcpercent < 50){
        xpbarelement.innerHTML`<img src="img/xp25.png" alt="xpbar" class="xpbarclass">`             
    }
        if (calcpercent > 50 && calcpercent < 75 ){
        xpbarelement.innerHTML`<img src="img/xp50.png" alt="xpbar" class="xpbarclass">`             
    }
        if (calcpercent > 75 && calcpercent < 100 ){
        xpbarelement.innerHTML`<img src="img/xp75.png" alt="xpbar" class="xpbarclass">`             
    }
        if (calcpercent = 100){
        xpbarelement.innerHTML`<img src="img/xp100.png" alt="xpbar" class="xpbarclass">`             
    }
